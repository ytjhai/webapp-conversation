...
const Button: FC<IButtonProps> = ({
  ...
  switch (type) {
    case 'primary':
      style = (disabled || loading) ? 'bg-primary-700/75 cursor-not-allowed text-white' : 'bg-primary-700 hover:bg-primary-700/75 hover:shadow-md cursor-pointer text-white hover:shadow-sm'
      break
    default:
